...
const NotePreview = ({ title, content }: Props) => {
  return (
    <span className="note-preview block col-span-2 max-w-[400px] rounded shadow-sm p-5 bg-x-contrast cursor-pointer text-lg hover:bg-x-main hover:border-transparent">
